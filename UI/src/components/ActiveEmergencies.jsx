...
import { Flame, Home, Clock, AlertTriangle, Loader2, Car, Wind, Mountain, Droplets, CheckCircle2, MapPin } from 'lucide-react';
import { API_BASE_URL, fetchWithAuth } from '../config.js';

const ActiveEmergencies = ({ onViewDetail, searchQuery }) => {
