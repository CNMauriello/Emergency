...
export default function ServicesTable({
  ...
  const handleDelete = async (id) => {
    const confirmed = window.confirm(
      `Are you sure you want to delete the service ${id}?`
    )
    ...
    try {
      ...
      alert('Error during service deletion.')
    }
  }
  ...
  const handleUpdate = async () => {
    ...
    try {
      ...
      console.error('Error during service modification:', err)
      alert('Error during service modification.')
    } finally {
      setSaving(false)
    }
  }
                  ...
                  <tr>
                    ...
                    >
                      <div className="flex flex-col items-center justify-center text-gray-500">
                        ...
                        <h2 className="text-[15px] font-bold text-gray-700">There are no services available</h2>
                        <p className="text-[13px] mt-1 text-gray-500">Add a new operational unit using the button "Register New Service".</p>
                      </div>
                    </td>
                  </tr>
                )}
                  ...
                  return (
                    ...
                    ========================= */}
                      <tr
                        ...
                        className={`border-b border-white/20 cursor-pointer transition ${isExpanded
                            ? 'bg-white/50'
                            : 'hover:bg-white/40'
                          }`}
                      >
