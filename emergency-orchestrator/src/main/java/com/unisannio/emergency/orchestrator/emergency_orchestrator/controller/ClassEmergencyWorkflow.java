...
import com.unisannio.emergency.orchestrator.emergency_orchestrator.service.WorkflowResolver;
...
public class ClassEmergencyWorkflow {
    ...
    public ClassEmergencyWorkflow(RankingStrategy strategy, WorkflowResolver resolver) {
    ...
    public final void execute(EmergencyEvent event){
        ...
        callService(chosen); //Chiamata HTTP
        /*
        try {
